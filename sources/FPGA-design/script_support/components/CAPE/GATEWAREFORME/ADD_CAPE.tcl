puts "======== Add cape option: GATEWAREFORME ========"

#-------------------------------------------------------------------------------
# Import HDL source files
#-------------------------------------------------------------------------------
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/apb_ctrl_status.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/P8_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/P9_11_18_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/P9_21_31_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/P9_41_42_IOPADS.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/CAPE.v}
import_files -hdl_source {script_support/components/CAPE/GATEWAREFORME/HDL/Diagram_Step.v}
